...
pie = species.groupby(["category"]).scientific_name.count().reset_index()
...
plt.axis('equal')
plt.pie(pie.scientific_name,autopct='%d%%')
plt.legend(pie.category)
plt.show()
...
plt.pie(category_pivot.percent_protected,autopct='%d%%')
plt.legend(category_pivot.category,)
...
observations[observations.scientific_name == "Ovis canadensis"]
